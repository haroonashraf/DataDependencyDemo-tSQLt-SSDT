CREATE PROCEDURE [MainTests].[test if view outputs correct data based on source data bound to database]
AS
BEGIN
	-- Data Dependency: 
  ...
  --============================================================================================================
	...
	-- Put best cars in last 5 years from database table into actual table 
	INSERT INTO MainTests.Actual 
	SELECT * FROM [$(BestCars)].dbo.BestCarsInLast5Years


	---===========================================================================================================
  -- (3) Assert (match actual table data with expected table data)
  --============================================================================================================
